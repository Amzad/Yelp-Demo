...
<img src='https://github.com/Amzad/Yelp-Demo/blob/master/yelp.gif?raw=true' title='Video Walkthrough' width='200' alt='Video Walkthrough' />

GIF created with Quicktime screen recorder

## Notes

Using the wakefromnib kept crashing the app whenever i used a detailed view.
